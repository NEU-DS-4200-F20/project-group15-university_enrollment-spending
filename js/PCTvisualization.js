...
(() => {
  d3.csv("data/PctData.csv").then((data) => {
...
/*
These are the expense columns in the PctData.csv file

TotalFTE
TuitionAndFeesRevenue
Auxiliary EnterprisesRevenue
OperatingRevenue
NonoperatingRevenue
TotalRevenuesPerFTE
