...
(() => {
  d3.csv("data/mergedDataFinal2.csv").then((data) => {
    ...
    const fields = [
      {
        slabel: "Instruction", //percent field
         dlabel: "Instruction - Current year total", // number of 
      },
      {
    ...
    linechartsHolder
      ...
      //Same as in assignment 8, slighly different
    ...
    violin.selectionDispatcher().on(dispatchString, function (selectedData) {
      ...
      //Check if there is matched records
      if (one) {
